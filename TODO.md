...
|---|---|---|---|
| Go-Backend (dieses Repo) | `Go/YaFT` | 0.1.4 | Phase 1 erledigt; CI publisht `ghcr.io/tehw0lf/yaft` + `yaft-db` |
...
Umgesetzt auf `fix/phase-1-backend-hardening`, Version 0.1.4.
